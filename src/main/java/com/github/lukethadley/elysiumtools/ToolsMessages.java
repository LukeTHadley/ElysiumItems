...
public class ToolsMessages {
    ...
    public static final String SHOTGUN_BOW_USE_MESSAGE = PLUGIN_PREFIX + "&7You used your " + Tools.SHOTGUN_BOW.getName() + "! &7Please wait 6 seconds before using again.";
    ...
    public static String getDemonicSwordDamagerMessage(String name){
        return PLUGIN_PREFIX + "&7You used your " + Tools.DEMONIC_SWORD.getName() + " &7and inflicted the Wither Effect on " + name + " &7for 10 seconds!" +
                "\n&7You can not use this ability for another 30 seconds.";
    }

    public static String getDemonicSwordDamageeMessage(String name){
        return PLUGIN_PREFIX + name + " &7used their " + Tools.DEMONIC_SWORD.getName() + " &7and inflicted you with the Wither Effect for 10 seconds!";
    }
}
