...
public class LuckOfTheNetherPickaxe extends CustomItem {
    ...
    private static final String ITEM_DISPLAY_NAME = net.md_5.bungee.api.ChatColor.of("#ff9966") + "&lLuck Of The Nether Pickaxe";
    private static final String DESCRIPTION = "This pickaxe will drop extra loot while mining nether blocks in the end!";
    private static final String[] ITEM_LORE = new String[]{"&7This pickaxe will drop", "&7extra loot while mining", "&7nether blocks in the end!"};
