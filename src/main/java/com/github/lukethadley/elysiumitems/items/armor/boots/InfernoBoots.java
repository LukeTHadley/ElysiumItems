...
public class InfernoBoots extends CustomItem {

    private static final String NAME = "InfernoBoots";
    private static final String ITEM_DISPLAY_NAME = net.md_5.bungee.api.ChatColor.of("#cc0000") + "&lInferno Boots";
