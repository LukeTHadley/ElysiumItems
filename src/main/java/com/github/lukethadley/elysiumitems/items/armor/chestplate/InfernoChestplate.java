...
public class InfernoChestplate extends CustomItem {

    private static final String NAME = "InfernoChestplate";
    private static final String ITEM_DISPLAY_NAME = net.md_5.bungee.api.ChatColor.of("#cc0000") + "&lInferno Chestplate";
