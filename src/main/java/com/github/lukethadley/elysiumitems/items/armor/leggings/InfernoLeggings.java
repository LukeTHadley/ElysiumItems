...
public class InfernoLeggings extends CustomItem {

    private static final String NAME = "InfernoLeggings";
    private static final String ITEM_DISPLAY_NAME = net.md_5.bungee.api.ChatColor.of("#cc0000") + "&lInferno Leggings";
