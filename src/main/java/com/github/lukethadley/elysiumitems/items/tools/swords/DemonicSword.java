...
public class DemonicSword extends CustomItem {
    ...
    private static final String[] ITEM_LORE = new String[]{net.md_5.bungee.api.ChatColor.of("#99004d") + "Forged in the depths of hell!", ChatColor.GRAY + "Has a 10% chance of applying the", ChatColor.GRAY + "wither effect to your enemy for 10 seconds"};
